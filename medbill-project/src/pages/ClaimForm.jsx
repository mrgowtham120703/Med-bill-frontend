...
export default function ClaimForm() {
    const [form, setForm] = useState({procedures: [{code:'',description:'',qty:1, uniCost:0}], medications: [], bedDays:0, ambulanceUsed: false, ambulanceCharge:0});
  ...
  function addProcedure() {
    setForm({...form, procedures: [...form.procedures, {code:'',description:'', qty:1, uniCost:0}]});
  }
        ...
        <div>
            ...
            {form.procedures.map((p,i) => (
                <div key={i} style={{border: '1px solid #ddd', padding:8, marginBottom:8}}>
                    ...
                    <input placeholder='uniCost' type='number' value={p.uniCost} onChange={e=>updateProcedure(i, 'uniCost', e.target.value)}/>
                </div>
            ))}
